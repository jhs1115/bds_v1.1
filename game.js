const GRADES = [
  { id: "ethereal", name: "에테리얼", chance: 1 / 500000000, color: "#ff7bd5", sellPrice: 500 },
  { id: "divine", name: "디바인", chance: 1 / 5000000, color: "#ff9b7a", sellPrice: 200 },
  { id: "mythic", name: "신화", chance: 1 / 50000, color: "#ff5e73", sellPrice: 80 },
  { id: "legend", name: "전설", chance: 1 / 5000, color: "#b68cff", sellPrice: 30 },
  { id: "epic", name: "에픽", chance: 1 / 500, color: "#ffd76f", sellPrice: 15 },
  { id: "rare", name: "레어", chance: 1 / 50, color: "#78dd93", sellPrice: 8 },
  { id: "uncommon", name: "언커먼", chance: 1 / 8, color: "#78b7ff", sellPrice: 3 },
  { id: "common", name: "커먼", chance: 1 / 2, color: "#c4cbe0", sellPrice: 1 },
];

const CHARACTERS = [
  { name: "별수호 궁수", grade: "common", emoji: "🏹", atk: 25, range: 102, speed: 1.0, cost: 200 },
  { name: "구름 검객", grade: "common", emoji: "⚔️", atk: 30, range: 75, speed: 1.2, cost: 250 },
  { name: "촛불 학자", grade: "common", emoji: "🕯️", atk: 10, range: 110, speed: 0.9, cost: 700 },
  { name: "부메랑 투척병", grade: "common", emoji: "🪃", atk: 20, range: 110, speed: 1.1, cost: 250 },
  { name: "숲의 정령", grade: "uncommon", emoji: "🌿", atk: 150, range: 150, speed: 1.6, cost: 1200 },
  { name: "백은 기사", grade: "uncommon", emoji: "🛡️", atk: 55, range: 80, speed: 1.5, cost: 600 },
  { name: "농장", grade: "uncommon", emoji: "🌾", atk: 0, range: 0, speed: 0, cost: 350, farmIncome: 70 },
  { name: "서리 척후병", grade: "uncommon", emoji: "🧊", atk: 15, range: 140, speed: 0.8, cost: 500 },
  { name: "청록 포수", grade: "uncommon", emoji: "🎯", atk: 60, range: 140, speed: 1.0, cost: 400 },
  { name: "달빛 요정", grade: "rare", emoji: "🧚", atk: 90, range: 130, speed: 1.3, cost: 400 },
  { name: "별마법사", grade: "rare", emoji: "🔮", atk: 150, range: 200, speed: 0.5, cost: 2000 },
  { name: "폭풍 창기사", grade: "rare", emoji: "⚡", atk: 100, range: 80, speed: 1.5, cost: 700 },
  { name: "수호 사제", grade: "rare", emoji: "📿", atk: 80, range: 120, speed: 0.9, cost: 1000 },
  { name: "천둥 사제", grade: "epic", emoji: "⛈️", atk: 50, range: 120, speed: 1.5, cost: 500 },
  { name: "사신 기사", grade: "epic", emoji: "💀", atk: 300, range: 90, speed: 1.0, cost: 1500 },
  { name: "화염 사수", grade: "epic", emoji: "🔥", atk: 25, range: 150, speed: 4.5, cost: 1000 },
  { name: "사령관", grade: "epic", emoji: "🎖️", atk: 0, range: 120, speed: 0, cost: 900, auraBuff: 0.18 },
  { name: "광휘 창병", grade: "epic", emoji: "🗡️", atk: 230, range: 110, speed: 0.8, cost: 1200 },
  { name: "태엽 포격수", grade: "epic", emoji: "⚙️", atk: 100, range: 200, speed: 1.2, cost: 2000 },
  { name: "드래곤 소환사", grade: "mythic", emoji: "🐉", atk: 100, range: 160, speed: 1.0, cost: 300 },
  { name: "빛의 작곡가", grade: "legend", emoji: "🎼", atk: 0, range: 140, speed: 0, cost: 1200, songMode: "attack" },
  { name: "무영 암살자", grade: "legend", emoji: "🌒", atk: 250, range: 90, speed: 1.3, cost: 600 },
  { name: "레인저", grade: "legend", emoji: "🦅", atk: 500, range: 400, speed: 0.5, cost: 3000 },
  { name: "태양신 아폴로", grade: "mythic", emoji: "☀️", atk: 10, range: 150, speed: 10, cost: 1500 },
  { name: "성운을 다루는자, 노바", grade: "ethereal", emoji: "🌌", atk: 250, range: 300, speed: 1, cost: 4500, swordDamage: 5000 },
  { name: "천공의 심판자", grade: "divine", emoji: "👼", atk: 480, range: 248, speed: 1.95, cost: 2200 },
  { name: "디아블로", grade: "ethereal", emoji: "😈", atk: 500, range: 280, speed: 2.2, cost: 3300 },
];

const CHARACTER_DROP_WEIGHTS = {
  "별수호 궁수": 1.2,
  "구름 검객": 1.05,
  "촛불 학자": 0.85,
  "부메랑 투척병": 0.9,
...
const GACHA_CHESTS = [
  {
    ...
    weights: { common: 68, uncommon: 24, rare: 6, epic: 1.4, legend: 0.45, mythic: 0.1, divine: 0.015, ethereal: 0.001 },
  },
  {
    id: "shiny",
    name: "빛나는 상자",
    ...
    weights: { common: 44, uncommon: 29, rare: 15, epic: 6, legend: 2, mythic: 0.6, divine: 0.12, ethereal: 0.015 },
  },
  {
    id: "brilliant",
    name: "찬란한 상자",
    ...
    weights: { common: 24, uncommon: 27, rare: 24, epic: 14, legend: 6.5, mythic: 2.3, divine: 0.6, ethereal: 0.08 },
  },
];
...
function normalizeContentData() {
  ...
  CHARACTERS.forEach((character) => {
    character.dropWeight = CHARACTER_DROP_WEIGHTS[character.name] || 1;
  });
...
function renderCodexCollection() {
  ...
  getCodexCharacters().forEach((character) => {
    ...
    card.innerHTML = `
      ...
      <div class="codexMeta">
        ${owned ? "보유 중" : "미보유"}<br>
        기본 확률 1/${Math.round(1 / grade.chance).toLocaleString()}<br>
        ${
          owned
            ? character.farmIncome
              ? `웨이브 수익 ${character.farmIncome}<br>배치 비용 ${character.cost}`
              : `공격 ${character.atk} · 사거리 ${character.range} · 공속 ${character.speed.toFixed(2)}<br>배치 비용 ${character.cost}`
            : "스펙은 획득 후 확인 가능"
        }
      </div>
    `;
...
function getCodexTooltipHtml(character, owned) {
  const grade = getGradeData(character.grade);
  const specialLines = getUnitSpecialDescription(character);
  ...
  const statSummary = owned
    ? character.farmIncome
      ? `웨이브 수익 ${character.farmIncome} · 배치 비용 ${character.cost}`
      : `공격 ${character.atk} · 사거리 ${character.range} · 공속 ${character.speed.toFixed(2)} · 배치 비용 ${character.cost}`
    : "미보유 상태에서는 상세 스펙이 잠겨 있습니다.";
  const installText = installLimit < MAX_TOTAL_PLACED_UNITS ? `최대 설치 ${installLimit}` : "설치 제한 없음";
  ...
  return `
    <div class="codexTooltipHeader">
      ...
      <div>
        ...
        <div class="codexTooltipGrade" style="color:${grade.color}">[${grade.name}] · 기본 확률 1/${Math.round(1 / grade.chance).toLocaleString()}</div>
      </div>
    </div>
    ...
    <div class="codexTooltipLimit">${installText}</div>
    <div class="codexTooltipLines">
      ${descriptionHtml}
    </div>
  `;
}
...
function enterBattleClear() {
  ...
  bRunning = false;
  draggingTower = null;
  const bossCoinReward = currentMap.finalBoss?.coinReward || 0;
  coins += bossCoinReward;
  activeBoss = null;
  document.getElementById("battleOverlayTitle").textContent = "게임 클리어";
  document.getElementById("battleOverlayText").textContent = `${currentMap.name} 제압 성공! 보너스 ${bossCoinReward} 코인`;
...
function getThunderPriestProfile(unit) {
  ...
  if (level >= 4) {
    return { atk: Math.round(unit.atk * 4.2), speed: 0.3, chains: 4, stun: 1.5 };
  }
  if (level >= 3) {
    return { atk: Math.round(unit.atk * 2.8), speed: 0.2, chains: 3, stun: 1 };
  }
  const stunByLevel = [0.1, 0.2, 0.2];
  return { atk: unit.atk, speed: unit.speed, chains: 1 + level, stun: stunByLevel[level] ?? 0.1 };
}
...
function getComposerSongData(unit) {
  const level = unit?.upgradeLevel || 0;
  const mode = unit?.songMode || "attack";
  const selectedAtk = [0.1, 0.1, 0.1, 0.15, 0.15][level] || 0.1;
  const selectedDiscount = [0.1, 0.1, 0.1, 0.15, 0.15][level] || 0.1;
  const selectedRange = [0.2, 0.2, 0.2, 0.25, 0.25][level] || 0.2;
  const baseAtMax = level >= 4 ? { atkPercent: 0.05, discountPercent: 0.05, rangePercent: 0.1 } : { atkPercent: 0, discountPercent: 0, rangePercent: 0 };
  const selected = {
  ...
  return {
    mode,
    atkPercent: baseAtMax.atkPercent + (selected?.atkPercent || 0),
    discountPercent: baseAtMax.discountPercent + (selected?.discountPercent || 0),
    rangePercent: baseAtMax.rangePercent + (selected?.rangePercent || 0),
  };
}

function getRangerWaveAuraPercent(unit) {
  if (!unit || unit.name !== "레인저" || (unit.rangerWaveAuraTime || 0) <= 0) return 0;
  return 0.15;
}
...
function getUnitSpecialDescription(unit) {
  ...
  const lines = {
    ...
    "서리 척후병": ["빙결 사격", "일반 적을 1초간 얼림 · 보스 면역 · 내부 쿨타임 10초"],
    "청록 포수": ["무난하고 안정적인 초반 원거리 딜러"],
    "달빛 요정": ["초반에 쓰기 좋은 빠른 원거리 딜러"],
    "별마법사": ["느리지만 강한 광역 폭발탄", "업그레이드 효율이 높아 후반 화력이 크게 오른다"],
    "폭풍 창기사": ["근거리 충격 창격", "일반 적 2초 기절 · 보스 면역 · 내부 쿨타임 10초"],
    "수호 사제": ["웨이브 시작 시 기지 회복", "웨이브마다 기지 HP를 10 회복"],
    "천둥 사제": ["연쇄 번개", "업그레이드에 따라 연쇄 수와 기절 시간이 증가", "Lv.3부터 느려지지만 한 방이 매우 강해짐"],
    "사신 기사": ["후반형 근거리 딜러", "보스 패턴 CC 면역은 추후 시스템과 함께 적용 예정"],
    "화염 사수": ["초고속 화염 분사", "범위 피해를 주는 화염 공격", "강철 속성 해제는 추후 시스템과 함께 적용 예정"],
    "사령관": ["지원 오라", "사거리 내 아군의 공격속도 증가", "전용 스킬은 추후 추가 예정"],
    "광휘 창병": ["빛의 관통 일격", "직선 상의 적을 함께 관통해 공격"],
    "태엽 포격수": ["집중 포화", "같은 적을 계속 때릴수록 공격속도가 최대 +5까지 증가"],
    "드래곤 소환사": ["값싼 신화 초반 타워", "초반 배치 부담이 적은 무난한 딜러"],
    "빛의 작곡가": ["메인 서포트 전설", "파괴/풍요/시야의 노래 중 하나를 선택", "노래 변경 쿨타임 10초 · 최대 설치 1"],
    "무영 암살자": ["근거리 암살형", "Lv.2부터 3번째 공격마다 강한 원형 휘두르기 발동", "최대 설치 5"],
    "레인저": ["메인 장거리 DPS", "웨이브 시작 후 15초 동안 주변 아군 사거리 +15%", "중첩은 최대 1.5배까지만 적용"],
    "태양신 아폴로": ["화염 구체 발사", "폭발 범위 피해를 주며 강철 속성 해제 예정", "초고속 연사형 신화 포격 타워"],
    "성운을 다루는자, 노바": ["공격할 때마다 우주의 검이 1개씩 공전", "검 5개가 모이면 진정한 검으로 합쳐져 관통 일격 발사", "Lv.4부터는 매 공격마다 진정한 검 발사"],
  };
...
function getUpgradeCost(unit) {
  ...
  if (unit.farmIncome) {
    const farmCostMultipliers = [0.45, 0.75, 1.25, 2.05];
    return roundToNearestFive(baseCost * farmCostMultipliers[level] * gradeMultiplier);
  }
  if (unit.name === "빛의 작곡가") {
    const composerCostMultipliers = [0.45, 0.7, 1.35, 2.2];
    const supportEffects = getSupportEffects(unit);
    return roundToNearestFive(baseCost * composerCostMultipliers[level] * gradeMultiplier * (1 - supportEffects.discountPercent));
  }
  const etherealCostBonus = unit.grade === "ethereal" ? 1.1 : 1;
  const supportEffects = getSupportEffects(unit);
  return roundToNearestFive(baseCost * UPGRADE_COST_MULTIPLIERS[level] * gradeMultiplier * etherealCostBonus * (1 - supportEffects.discountPercent));
}

function getUpgradeEffects(unit, level = (unit.upgradeLevel || 0) + 1) {
  if (unit.farmIncome) {
    const farmBoosts = [40, 60, 120, 180];
    return { farmIncome: farmBoosts[level - 1] || 0 };
  }
  ...
  if (unit.name === "빛의 작곡가") {
    ...
    return composerEffects[level - 1] || {};
  }

  if (unit.name === "사령관") {
    const commanderEffects = [
      { rangePercent: 0.08, auraBuff: 0.05 },
      { rangePercent: 0.08, auraBuff: 0.05 },
      { rangePercent: 0.1, auraBuff: 0.08 },
      { rangePercent: 0.12, auraBuff: 0.12 },
    ];
    return commanderEffects[level - 1] || {};
  }

  if (unit.name === "성운을 다루는자, 노바") {
    const novaEffects = [
      { swordDamageFlat: 500, rangePercent: 0.04 },
      { swordDamageFlat: 500, atkPercent: 0.08 },
      { swordDamageFlat: 500, rangePercent: 0.06 },
      { swordDamageFlat: 500, speedOverride: 0.5, trueSwordEveryAttack: true },
    ];
    return novaEffects[level - 1] || {};
  }

  if (unit.grade === "ethereal") {
    ...
    const effects = etherealEffects[level - 1] || {};
    return {
      ...effects,
  ...
  const namedEffects = {
    ...
    "별마법사": [
      { rangePercent: 0.12, atkPercent: 0.06 },
      { atkPercent: 0.2, rangePercent: 0.1 },
      { atkPercent: 0.18, speedPercent: 0.1 },
      { atkPercent: 0.36, rangePercent: 0.18, speedPercent: 0.14 },
    ],
    "레인저": [
      { speedPercent: 0.18 },
      { speedPercent: 0.2 },
      { speedPercent: 0.22 },
      { atkPercent: 1.2, speedPercent: -0.2 },
    ],
  };

  const selectedEffects = namedEffects[unit.name] || effectsByGrade[unit.grade] || defaultEffects;
  const baseEffects = selectedEffects[level - 1] || {};
...
function getUpgradeSummary(unit) {
  ...
  if (effects.atkPercent) {
    ...
    pieces.push({ label: "공격력", value: `+${gain}` });
  }
  if (effects.rangePercent) {
    const gain = Math.round(unit.range * effects.rangePercent);
    pieces.push({ label: "사거리", value: `+${gain}` });
  }
  if (effects.auraBuff) {
    pieces.push({ label: "오라 공속", value: `+${Math.round(effects.auraBuff * 100)}%` });
  }
  if (effects.speedPercent) {
    const gain = Number((unit.speed * effects.speedPercent).toFixed(2));
    pieces.push({ label: "공속", value: `${gain >= 0 ? "+" : ""}${gain}` });
  }
  if (effects.speedOverride != null) {
    pieces.push({ label: "공속", value: `${effects.speedOverride.toFixed(2)}로 변경` });
  }
  if (effects.swordDamageFlat) {
    pieces.push({ label: "검 데미지", value: `+${effects.swordDamageFlat}` });
  }
  if (effects.farmIncome) pieces.push({ label: "웨이브 수익", value: `+${effects.farmIncome}` });
  if (effects.songAtkBonus) pieces.push({ label: "노래 공격 보너스", value: `+${Math.round(effects.songAtkBonus * 100)}% (전 모드)` });
  if (effects.songDiscountBonus) pieces.push({ label: "노래 할인 보너스", value: `+${Math.round(effects.songDiscountBonus * 100)}% (전 모드)` });
  if (effects.songRangeBonus) pieces.push({ label: "노래 사거리 보너스", value: `+${Math.round(effects.songRangeBonus * 100)}% (전 모드)` });
  if (unit.name === "부메랑 투척병") {
    ...
    if (nextBounces > currentBounces) {
      pieces.push({ label: "튕김", value: `${nextBounces}회` });
    }
  }
  if (unit.name === "무영 암살자" && nextLevel === 2) pieces.push({ label: "범위 데미지", value: "3타마다 회전 베기 100" });
  if (unit.name === "무영 암살자" && nextLevel === 3) pieces.push({ label: "범위 데미지", value: "회전 베기 200" });
  if (unit.name === "무영 암살자" && nextLevel === 4) pieces.push({ label: "범위 데미지", value: "회전 베기 250" });
  if (unit.name === "성운을 다루는자, 노바" && nextLevel === 4) pieces.push({ label: "진정한 검", value: "매 공격마다 발사" });
  if (effects.skillUnlock && nextLevel === 2) pieces.push({ label: "스킬 강화", value: "Destroy Time 개방" });
  if (effects.skillOverdrive && nextLevel === 4) pieces.push({ label: "스킬 강화", value: "심연 과부하 활성화" });
  return pieces;
}
...
function triggerUltraRareGachaEffect(character) {
  ...
  const headline = isNova ? "차원이 검으로 찢어진 순간" : headlineByGrade[grade.id] || `${grade.name} 등장`;
  const subline = isNova ? "별빛이 꺼지고, 성운이 붕괴하며, 하늘을 가르는 절대 검과 함께 노바가 현현한다" : sublineByGrade[grade.id] || "운명이 완전히 기울었다";
  const auraLabel = isNova ? "COSMIC SOVEREIGN" : auraLabelByGrade[grade.id] || grade.name.toUpperCase();
  const cardClass = `ultraRareCard is-${grade.id}${isNova ? " is-nova" : ""}`;
        ...
        <div class="novaNameplate">
          ...
          <div class="novaIdentityRow">
            ...
            <div>
              ...
              <div class="novaGrade">[${grade.name}] · 기본 확률 ${Math.round(1 / grade.chance).toLocaleString()}분의 1</div>
            </div>
          </div>
    ...
    : `
      ...
      <div class="ultraRareCardWrap">
        ...
        <div class="${cardClass}" style="border-color:${grade.color}">
          ...
          <div class="ultraRareOdds">기본 확률 ${Math.round(1 / grade.chance).toLocaleString()}분의 1</div>
        </div>
      </div>
    `;
...
function getCharacterOddsText(chest, character) {
  const grade = getGradeData(character.grade);
  const denominator = Math.max(1, Math.round(1 / grade.chance));
  return `기본 확률 1/${denominator.toLocaleString()}`;
}
  ...
  ownedChars.forEach((character) => {
    ...
    card.innerHTML = `
      ...
      <div>
        ...
        <div class="card-stats">${character.farmIncome ? `웨이브 수익 ${character.farmIncome}` : `공격 ${character.atk} · 사거리 ${character.range}`}</div>
        <div class="card-stats">보유 수량 X ${character.quantity || 1}</div>
      </div>
    `;
    collection.appendChild(card);
  });
  ...
  bagItems.forEach((character) => {
    ...
    card.innerHTML = `
      ...
      <div class="bagCardMeta">
        ${character.farmIncome ? `웨이브 수익 ${character.farmIncome}` : `공격 ${character.atk} · 사거리 ${character.range}`}<br>
        배치 비용 ${character.cost}<br>
        최대 설치 ${Math.min(getUnitPlacementLimit(character), MAX_TOTAL_PLACED_UNITS)}개<br>
        기본 레벨 Lv.0<br>
        보유 수량 X ${character.quantity || 1}
      </div>
...
function showUnitInfo(unit) {
  ...
  const chanceStr = `1/${Math.round(1 / grade.chance).toLocaleString()}`;
  panel.innerHTML = `
    ...
    <div>등장 확률 <strong>${chanceStr}</strong></div>
    <div>배치 비용 <strong>${unit.cost}</strong></div>
    <div>최대 설치 <strong>${Math.min(getUnitPlacementLimit(unit), MAX_TOTAL_PLACED_UNITS)}개</strong></div>
    <div>${unit.farmIncome ? `웨이브 수익 <strong>${unit.farmIncome}</strong>` : unit.name === "사령관" ? `지원 오라 범위 <strong>${unit.range}</strong>` : `공격력 <strong>${unit.atk}</strong>`}</div>
    <div>${unit.farmIncome ? "전투 공격 없음" : unit.name === "사령관" ? `오라 공속 버프 <strong>+${Math.round((unit.auraBuff || 0.18) * 100)}%</strong>` : `사거리 <strong>${unit.range}</strong>`}</div>
    <div>${unit.farmIncome ? "설치 위치가 중요해요" : unit.name === "사령관" ? "전투 공격 없음" : `공격 속도 <strong>${unit.speed.toFixed(2)}</strong>`}</div>
  `;

  if (unit.name === "성운을 다루는자, 노바") {
    panel.innerHTML += `<div>검 데미지 <strong>${getNovaSwordDamage(unit).toLocaleString()}</strong></div>`;
...
function enterGameOver() {
  ...
  bRunning = false;
  draggingTower = null;
  document.getElementById("battleOverlayTitle").textContent = "게임 오버";
  document.getElementById("battleOverlayText").textContent = `${bWave} 웨이브까지 버텼습니다.`;
  document.getElementById("battleOverlay").style.display = "flex";
  ...
  placedUnits.forEach((unit) => {
    ...
    if (closestEnemy) {
      ...
      if (unit.name === "성운을 다루는자, 노바") {
        ...
        if (shouldFireTrueSword) {
          projectiles.push({
            ...
            linePierceLength: Math.max(340, effectiveRange + 120),
            linePierceWidth: 34,
            hitTargetIds: new Set(),
            done: false,
      ...
      const assassinSwingDamage = unit.name === "무영 암살자" && (unit.upgradeLevel || 0) >= 2 && unit.attackCycle % 3 === 0
        ? Math.min(250, Math.max(100, ((unit.upgradeLevel || 0) - 1) * 100))
        : 0;
      ...
      const splashRatio =
        ...
        0;
      const freezeDuration = unit.name === "서리 척후병" && unit.specialCooldown <= 0 ? 1 : 0;
...
function updateProjectiles(dt) {
  projectiles.forEach((projectile) => {
    ...
    if (distance < 10) {
      ...
      hitEnemy(projectile.target, projectile.atk, true);
      ...
      if (projectile.splashRadius > 0) {
        ...
        enemies.forEach((enemy) => {
          ...
          const splashDamage = projectile.assassinSwingDamage > 0
...
function checkWaveEnd() {
  ...
  const waveCoinReward = 2 + Math.floor(bWave / 2) + (currentMap.coinRewardBonus || 0);
  bMoney += waveMoneyReward;
  coins += waveCoinReward;
  updateLobbyUI();
  updateGachaUI();
  spawnFloatingText(battleCanvas.width / 2, 54, `+${waveMoneyReward} 머니`, "#9ff7c2");
  spawnFloatingText(battleCanvas.width / 2, 82, `+${waveCoinReward} 코인`, "#ffe08a");
  showBattleMsg(`웨이브 클리어! +${waveMoneyReward} 머니 · +${waveCoinReward} 코인`);
  updateBattleUI();
...
function drawBattle() {
  ...
  areaIndicators.forEach((indicator) => {
    ...
    bctx.beginPath();
    bctx.arc(indicator.x, indicator.y, indicator.radius * 0.72, 0, Math.PI * 2);
    bctx.stroke();
    bctx.setLineDash([]);
    if (indicator.label) {
